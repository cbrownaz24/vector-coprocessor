...
(
  ...
  output         vec_cmd_val_Dhl_out,
  input          vec_cmd_rdy,
  output [118:0] vec_cmd_msg_Dhl_out,
  input          vec_idle,

  // Vector reduction writeback to scalar RF
  input          vec_reduce_val,
  input  [31:0]  vec_reduce_result,
  input  [ 4:0]  vec_reduce_rd
);
  ...
  always @ (*) begin
    ...
    casez ( ir_Dhl )
      ...
      // Vector instructions - all dispatched to vector coprocessor
      // They pass through the scalar pipeline as NOPs (no scalar RF write, no mem, no branch)
      // rs1_en and rs2_en are set so we can read scalar operands for VS_ARITH and VMEM instructions
      //                                j     br       pc      op0      rs1 op1       rs2 alu       md       md md     ex      mem  mem   memresp wb      rf      csr
      //                            val taken type     muxsel  muxsel   en  muxsel    en  fn        fn       en muxsel muxsel  rq   len   muxsel  muxsel  wen wa  wen

      // VV Arithmetic - no scalar register reads needed
      `RISCV_INST_MSG_VVADD   :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VVSUB   :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VVMUL   :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VVDIV   :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VVREM   :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VVAND   :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VVOR    :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VVXOR   :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VVSLL   :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VVSRL   :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VVSRA   :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };

      // VS Arithmetic - read rs2 from scalar register file
      `RISCV_INST_MSG_VSADD   :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_rdat,  y,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VSSUB   :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_rdat,  y,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VSMUL   :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_rdat,  y,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VSDIV   :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_rdat,  y,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VSREM   :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_rdat,  y,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };

      // Vector Memory
      // VLW:  rs1=base addr (scalar), read via op0
      // VSW:  rs1=vec src (NOT scalar), rs2=base addr (scalar), read via op1
      // VLWS: rs1=base addr, rs2=stride, read both
      // VSWS: rs1=base addr, rs2=stride, read both
      `RISCV_INST_MSG_VLW     :cs={ y,  n,    br_none, pm_p,   am_rdat, y,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VSW     :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_rdat,  y,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VLWS    :cs={ y,  n,    br_none, pm_p,   am_rdat, y,  bm_rdat,  y,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VSWS    :cs={ y,  n,    br_none, pm_p,   am_rdat, y,  bm_rdat,  y,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };

      // Vector Config
      `RISCV_INST_MSG_SETVL   :cs={ y,  n,    br_none, pm_p,   am_rdat, y,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_CVM     :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VFENCE  :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };

      // Vector Comparison - no scalar RF write
      `RISCV_INST_MSG_VSEQ    :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VSLT    :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VSLE    :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VSGT    :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VSGE    :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VSNE    :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };

      // Vector Reduction - result written back to scalar RF via vec unit
      `RISCV_INST_MSG_VREDSUM :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VREDAND :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
      `RISCV_INST_MSG_VREDOR  :cs={ y,  n,    br_none, pm_p,   am_0,    n,  bm_0,     n,  alu_add,  md_x,    n, mdm_x, em_alu, nr,  ml_x, dmm_x,  wm_alu, n,  rx, n   };
  ...
  wire [1:0] vec_category_Dhl =
    ...
    (ir_Dhl[`RISCV_INST_MSG_FUNCT3] == 3'b010) ? 2'd2 :  // VMEM
    (ir_Dhl[`RISCV_INST_MSG_FUNCT3] == 3'b011) ? 2'd3 :  // CONFIG
    (ir_Dhl[`RISCV_INST_MSG_FUNCT3] == 3'b100) ? 2'd0 :  // COMP (uses VV_ARITH cat with comparison flag)
  ...
  // VSWS: rs1 holds base, rs2 holds stride, so vs1 lives in the rd slot.
  wire is_vsws_Dhl =
  ...
  assign vec_cmd_msg_Dhl_out = {
    ...
    32'd0,                        // [111:80]  stride - filled by Core from dpath
  ...
  // Stall for VFENCE: stall decode until vector unit signals idle
  wire stall_vfence_Dhl = is_vfence_Dhl && !vec_idle;

  // Stall when vector command queue is full
  wire stall_vec_full_Dhl = is_vec_inst_Dhl && !is_vfence_Dhl && !vec_cmd_rdy;
