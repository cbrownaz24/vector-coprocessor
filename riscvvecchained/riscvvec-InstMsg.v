...
//------------------------------------------------------------------------
// RISC-V Vector Extension (Custom-0 opcode = 0x0B)
//------------------------------------------------------------------------
// Format: R-type using custom-0 opcode
//   funct7[6:0] | vs2/rs2[4:0] | vs1/rs1[4:0] | funct3[2:0] | vd/rd[4:0] | 0001011
//
// funct3 categories:
//   000 = VV_ARITH (vector-vector arithmetic)
//   001 = VS_ARITH (vector-scalar arithmetic)
//   010 = VMEM    (vector memory load/store)
//   011 = VCONFIG (configuration: SETVL, CVM, VFENCE)
//   100 = VCOMP   (vector comparison, sets mask)
//   101 = VREDUCE (reduction operations)

// Vector-Vector Arithmetic (funct3=000)
`define RISCV_INST_MSG_VVADD    32'b0000000_?????_?????_000_?????_0001011
`define RISCV_INST_MSG_VVSUB    32'b0000001_?????_?????_000_?????_0001011
`define RISCV_INST_MSG_VVMUL    32'b0000010_?????_?????_000_?????_0001011
`define RISCV_INST_MSG_VVDIV    32'b0000011_?????_?????_000_?????_0001011
`define RISCV_INST_MSG_VVREM    32'b0000100_?????_?????_000_?????_0001011
`define RISCV_INST_MSG_VVAND    32'b0000101_?????_?????_000_?????_0001011
`define RISCV_INST_MSG_VVOR     32'b0000110_?????_?????_000_?????_0001011
`define RISCV_INST_MSG_VVXOR    32'b0000111_?????_?????_000_?????_0001011
`define RISCV_INST_MSG_VVSLL    32'b0001000_?????_?????_000_?????_0001011
`define RISCV_INST_MSG_VVSRL    32'b0001001_?????_?????_000_?????_0001011
`define RISCV_INST_MSG_VVSRA    32'b0001010_?????_?????_000_?????_0001011

// Vector-Scalar Arithmetic (funct3=001)
`define RISCV_INST_MSG_VSADD    32'b0000000_?????_?????_001_?????_0001011
`define RISCV_INST_MSG_VSSUB    32'b0000001_?????_?????_001_?????_0001011
`define RISCV_INST_MSG_VSMUL    32'b0000010_?????_?????_001_?????_0001011
`define RISCV_INST_MSG_VSDIV    32'b0000011_?????_?????_001_?????_0001011
`define RISCV_INST_MSG_VSREM    32'b0000100_?????_?????_001_?????_0001011

// Vector Memory (funct3=010)
`define RISCV_INST_MSG_VLW      32'b0000000_?????_?????_010_?????_0001011
`define RISCV_INST_MSG_VSW      32'b0000001_?????_?????_010_?????_0001011
`define RISCV_INST_MSG_VLWS     32'b0000010_?????_?????_010_?????_0001011
`define RISCV_INST_MSG_VSWS     32'b0000011_?????_?????_010_?????_0001011

// Vector Config (funct3=011)
`define RISCV_INST_MSG_SETVL    32'b0000000_?????_?????_011_?????_0001011
`define RISCV_INST_MSG_CVM      32'b0000001_00000_00000_011_00000_0001011
`define RISCV_INST_MSG_VFENCE   32'b0000010_00000_00000_011_00000_0001011

// Vector Comparison (funct3=100) - sets mask register
`define RISCV_INST_MSG_VSEQ     32'b0000000_?????_?????_100_?????_0001011
`define RISCV_INST_MSG_VSLT     32'b0000001_?????_?????_100_?????_0001011
`define RISCV_INST_MSG_VSLE     32'b0000010_?????_?????_100_?????_0001011
`define RISCV_INST_MSG_VSGT     32'b0000011_?????_?????_100_?????_0001011
`define RISCV_INST_MSG_VSGE     32'b0000100_?????_?????_100_?????_0001011
`define RISCV_INST_MSG_VSNE     32'b0000101_?????_?????_100_?????_0001011

// Vector Reduction (funct3=101)
`define RISCV_INST_MSG_VREDSUM  32'b0000000_?????_?????_101_?????_0001011
`define RISCV_INST_MSG_VREDAND  32'b0000001_?????_?????_101_?????_0001011
`define RISCV_INST_MSG_VREDOR   32'b0000010_?????_?????_101_?????_0001011

// Custom-0 opcode constant
`define RISCV_INST_MSG_CUSTOM0_OPCODE 7'b0001011

// Helper: detect any vector instruction
`define RISCV_INST_MSG_IS_VEC(inst) (inst[6:0] == 7'b0001011)
  ...
  always @ ( * ) begin
    ...
    if ( msg === 32'bx ) begin
      ...
      casez ( msg )
        ...
        // Vector instructions
        `RISCV_INST_MSG_VVADD   : $sformat( dasm, "vvadd  v%02d, v%02d, v%02d     ", rd,  rs1, rs2    );
        `RISCV_INST_MSG_VVSUB   : $sformat( dasm, "vvsub  v%02d, v%02d, v%02d     ", rd,  rs1, rs2    );
        `RISCV_INST_MSG_VVMUL   : $sformat( dasm, "vvmul  v%02d, v%02d, v%02d     ", rd,  rs1, rs2    );
        `RISCV_INST_MSG_VVDIV   : $sformat( dasm, "vvdiv  v%02d, v%02d, v%02d     ", rd,  rs1, rs2    );
        `RISCV_INST_MSG_VVREM   : $sformat( dasm, "vvrem  v%02d, v%02d, v%02d     ", rd,  rs1, rs2    );
        `RISCV_INST_MSG_VVAND   : $sformat( dasm, "vvand  v%02d, v%02d, v%02d     ", rd,  rs1, rs2    );
        `RISCV_INST_MSG_VVOR    : $sformat( dasm, "vvor   v%02d, v%02d, v%02d     ", rd,  rs1, rs2    );
        `RISCV_INST_MSG_VVXOR   : $sformat( dasm, "vvxor  v%02d, v%02d, v%02d     ", rd,  rs1, rs2    );
        `RISCV_INST_MSG_VVSLL   : $sformat( dasm, "vvsll  v%02d, v%02d, v%02d     ", rd,  rs1, rs2    );
        `RISCV_INST_MSG_VVSRL   : $sformat( dasm, "vvsrl  v%02d, v%02d, v%02d     ", rd,  rs1, rs2    );
        `RISCV_INST_MSG_VVSRA   : $sformat( dasm, "vvsra  v%02d, v%02d, v%02d     ", rd,  rs1, rs2    );
        `RISCV_INST_MSG_VSADD   : $sformat( dasm, "vsadd  v%02d, v%02d, r%02d     ", rd,  rs1, rs2    );
        `RISCV_INST_MSG_VSSUB   : $sformat( dasm, "vssub  v%02d, v%02d, r%02d     ", rd,  rs1, rs2    );
        `RISCV_INST_MSG_VSMUL   : $sformat( dasm, "vsmul  v%02d, v%02d, r%02d     ", rd,  rs1, rs2    );
        `RISCV_INST_MSG_VSDIV   : $sformat( dasm, "vsdiv  v%02d, v%02d, r%02d     ", rd,  rs1, rs2    );
        `RISCV_INST_MSG_VSREM   : $sformat( dasm, "vsrem  v%02d, v%02d, r%02d     ", rd,  rs1, rs2    );
        `RISCV_INST_MSG_VLW     : $sformat( dasm, "vlw    v%02d, r%02d            ", rd,  rs1         );
        `RISCV_INST_MSG_VSW     : $sformat( dasm, "vsw    v%02d, r%02d            ", rs1, rs2         );
        `RISCV_INST_MSG_VLWS    : $sformat( dasm, "vlws   v%02d, r%02d, r%02d     ", rd,  rs1, rs2    );
        `RISCV_INST_MSG_VSWS    : $sformat( dasm, "vsws   v%02d, r%02d, r%02d     ", rs1, rs1, rs2    );
        `RISCV_INST_MSG_SETVL   : $sformat( dasm, "setvl  r%02d, r%02d            ", rd,  rs1         );
        `RISCV_INST_MSG_CVM     : $sformat( dasm, "cvm                           "                    );
        `RISCV_INST_MSG_VFENCE  : $sformat( dasm, "vfence                        "                    );
        `RISCV_INST_MSG_VSEQ    : $sformat( dasm, "vseq   v%02d, v%02d            ", rs1, rs2         );
        `RISCV_INST_MSG_VSLT    : $sformat( dasm, "vslt   v%02d, v%02d            ", rs1, rs2         );
        `RISCV_INST_MSG_VSLE    : $sformat( dasm, "vsle   v%02d, v%02d            ", rs1, rs2         );
        `RISCV_INST_MSG_VSGT    : $sformat( dasm, "vsgt   v%02d, v%02d            ", rs1, rs2         );
        `RISCV_INST_MSG_VSGE    : $sformat( dasm, "vsge   v%02d, v%02d            ", rs1, rs2         );
        `RISCV_INST_MSG_VSNE    : $sformat( dasm, "vsne   v%02d, v%02d            ", rs1, rs2         );
        `RISCV_INST_MSG_VREDSUM : $sformat( dasm, "vredsum r%02d, v%02d           ", rd,  rs1         );
        `RISCV_INST_MSG_VREDAND : $sformat( dasm, "vredand r%02d, v%02d           ", rd,  rs1         );
        `RISCV_INST_MSG_VREDOR  : $sformat( dasm, "vredor r%02d, v%02d            ", rd,  rs1         );
  ...
  begin
    ...
    begin
      ...
      casez ( msg )
        ...
        // Vector instructions
        `RISCV_INST_MSG_VVADD   : $sformat( minidasm, "vvadd ");
        `RISCV_INST_MSG_VVSUB   : $sformat( minidasm, "vvsub ");
        `RISCV_INST_MSG_VVMUL   : $sformat( minidasm, "vvmul ");
        `RISCV_INST_MSG_VVDIV   : $sformat( minidasm, "vvdiv ");
        `RISCV_INST_MSG_VVREM   : $sformat( minidasm, "vvrem ");
        `RISCV_INST_MSG_VVAND   : $sformat( minidasm, "vvand ");
        `RISCV_INST_MSG_VVOR    : $sformat( minidasm, "vvor  ");
        `RISCV_INST_MSG_VVXOR   : $sformat( minidasm, "vvxor ");
        `RISCV_INST_MSG_VVSLL   : $sformat( minidasm, "vvsll ");
        `RISCV_INST_MSG_VVSRL   : $sformat( minidasm, "vvsrl ");
        `RISCV_INST_MSG_VVSRA   : $sformat( minidasm, "vvsra ");
        `RISCV_INST_MSG_VSADD   : $sformat( minidasm, "vsadd ");
        `RISCV_INST_MSG_VSSUB   : $sformat( minidasm, "vssub ");
        `RISCV_INST_MSG_VSMUL   : $sformat( minidasm, "vsmul ");
        `RISCV_INST_MSG_VSDIV   : $sformat( minidasm, "vsdiv ");
        `RISCV_INST_MSG_VSREM   : $sformat( minidasm, "vsrem ");
        `RISCV_INST_MSG_VLW     : $sformat( minidasm, "vlw   ");
        `RISCV_INST_MSG_VSW     : $sformat( minidasm, "vsw   ");
        `RISCV_INST_MSG_VLWS    : $sformat( minidasm, "vlws  ");
        `RISCV_INST_MSG_VSWS    : $sformat( minidasm, "vsws  ");
        `RISCV_INST_MSG_SETVL   : $sformat( minidasm, "setvl ");
        `RISCV_INST_MSG_CVM     : $sformat( minidasm, "cvm   ");
        `RISCV_INST_MSG_VFENCE  : $sformat( minidasm, "vfence");
        `RISCV_INST_MSG_VSEQ    : $sformat( minidasm, "vseq  ");
        `RISCV_INST_MSG_VSLT    : $sformat( minidasm, "vslt  ");
        `RISCV_INST_MSG_VSLE    : $sformat( minidasm, "vsle  ");
        `RISCV_INST_MSG_VSGT    : $sformat( minidasm, "vsgt  ");
        `RISCV_INST_MSG_VSGE    : $sformat( minidasm, "vsge  ");
        `RISCV_INST_MSG_VSNE    : $sformat( minidasm, "vsne  ");
        `RISCV_INST_MSG_VREDSUM : $sformat( minidasm, "vrdsum");
        `RISCV_INST_MSG_VREDAND : $sformat( minidasm, "vrdand");
        `RISCV_INST_MSG_VREDOR  : $sformat( minidasm, "vrdor ");
